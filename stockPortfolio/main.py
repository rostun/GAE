...
app = webapp2.WSGIApplication([ # basic routes, take us to the three classes
	('/nation', 'nation.Nation'), # country 
	('/company', 'company.Company'), # company 
], debug=True, config=config)

# regular expressions
app.router.add(webapp2.Route(r'/country/<id:[0-9]+> <:/?>', 'company.Company')) # will take a company and an id (string of integers), will look up an individual company
